...
export default function About() {
  return (
    ...
    >
      <FadeUp>
        <h1 className="py-4 mt-8 text-3xl font-medium text-center md:text-3xl text-neutral-800">
          We Make Websites for Small Businesses.
        </h1>
      </FadeUp>
      <div className="flex self-center w-24 border-t-2 border-highlight2"></div>
      <FadeIn>
        <div className="max-w-3xl mx-auto mt-4 text-lg leading-7 text-center lg:text-2xl text-neutral-900 md:text-xl">
          <p>
